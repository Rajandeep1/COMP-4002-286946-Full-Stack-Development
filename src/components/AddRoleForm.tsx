// AddRoleForm — form component using useFormInput hook.
// Sprint 4 refactor: submission is now async since leadershipService
// calls Prisma. The button shows "Saving…" during the DB operation.
...
const AddRoleForm = ({ leadership: _leadership, onSuccess }: AddRoleFormProps) => {
