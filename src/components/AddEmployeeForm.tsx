// AddEmployeeForm — form component using useFormInput hook.
// Sprint 4 refactor: submission is now async since createEmployee
// calls Prisma via the service layer. A "Saving…" state is shown
// while the database operation completes.
